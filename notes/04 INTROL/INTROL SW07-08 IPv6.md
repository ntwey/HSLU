...
- SLAAC, Stateless DHCPv6 und Stateful DHCPv6
- Aufbau eines IPv6-Routings
- Dual Stack und IPv6-over-IPv4 Tunnel

## Teil 1 – IPv6 Adressvergabe
### SLAAC
- Client generiert selbständig Adresse
- Router Advertisements liefern:
  - Prefix
  - Flags (A = Autoconf, M = Managed)

### Stateless DHCPv6
- DHCP liefert zusätzliche Infos (DNS etc.)
- IPv6-Adresse weiterhin via SLAAC

### Stateful DHCPv6
- Vollständige IP-Vergabe durch DHCP-Server
- Vergleichbar mit IPv4-DHCP

## Teil 2 – IPv6 Routing
- Zwei Subnetze via Router verbinden
- Statische Routen setzen
- ICMPv6 essenziell (Neighbor Discovery, RA, RS)

## Teil 3 – Dual Stack
- IPv4 + IPv6 parallel
- Wichtig für Migrationsszenarien

## Teil 4 – IPv6-over-IPv4 Tunnel
- Verpacken von IPv6 Paketen in IPv4
- Nutzbar, wenn bestehende Infrastruktur noch kein nativen IPv6 unterstützt

## Erkenntnisse
- IPv6 ist vollständig anders strukturiert als IPv4
- Neighbor Discovery ersetzt ARP
- Autokonfiguration reduziert Administrationsaufwand
