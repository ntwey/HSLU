    ...
    public static void main(final String[] args) {
        ...
        */
        ...
        try {
            ...
            System.out.println("Max Temperatur: " + course.getMaxTemperature());
            System.out.println("Durchschnitt: " + course.getAverageTemperature());

            System.out.println("\nErster Messpunkt:");
            Measurement first = course.getAll().get(0);
            System.out.println("Zeit: " + first.getTimestamp());
            System.out.println("Temp: " + first.getTemperature());
            System.out.println("Luftfeuchte: " + first.getHumidity());
